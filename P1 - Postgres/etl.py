...
def process_log_file(cur, filepath):
    ...
    time_df = pd.concat(time_data, join='outer', axis=1).drop_duplicates()
    ...
    # load user table
    user_df = df[['userId','firstName','lastName','gender','level']].drop_duplicates().sort_values(by='userId')
